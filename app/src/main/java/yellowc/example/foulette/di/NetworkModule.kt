...
import yellowc.example.foulette.data.remote.datasourceimpl.JsoupMenuServiceImpl
    ...
    */
    ...
    fun provideHttpLoggingInterceptor(): HttpLoggingInterceptor {
        return HttpLoggingInterceptor().apply {
            level = if (yellowc.example.foulette.BuildConfig.DEBUG) HttpLoggingInterceptor.Level.BODY
